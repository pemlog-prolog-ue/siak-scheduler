...
% alin
kapasitas_kelas(k_001,60,59).
kapasitas_kelas(k_002,70,67).
kapasitas_kelas(k_003,60,49).
kapasitas_kelas(k_004,68,69).

% anum
kapasitas_kelas(k_005,80,79).
kapasitas_kelas(k_006,80,79).

% basdat
kapasitas_kelas(k_007,67,66).
kapasitas_kelas(k_008,69,68).
kapasitas_kelas(k_009,66,66).
kapasitas_kelas(k_010,69,68).
kapasitas_kelas(k_011,69,67).
kapasitas_kelas(k_012,66,66).

% ddp1
kapasitas_kelas(k_013,55,49).

% ddp2
kapasitas_kelas(k_014,60,60).
kapasitas_kelas(k_015,60,50).
kapasitas_kelas(k_016,60,60).
kapasitas_kelas(k_017,60,45).
kapasitas_kelas(k_018,60,60).
kapasitas_kelas(k_019,60,31).
kapasitas_kelas(k_020,60,60).

% daa
kapasitas_kelas(k_021,60,10).
kapasitas_kelas(k_022,60,59).

% grafkom
kapasitas_kelas(k_023,50,17).

% jarkom
kapasitas_kelas(k_024,55,50).

% kalkulus 1
kapasitas_kelas(k_025,71,68).

% kalkulus 2
kapasitas_kelas(k_026,73,72).
kapasitas_kelas(k_027,73,73).
kapasitas_kelas(k_028,65,65).

% kp
kapasitas_kelas(k_029,50,9).

% komas
kapasitas_kelas(k_030,60,34).
kapasitas_kelas(k_031,61,58).
kapasitas_kelas(k_032,60,60).

% Kriptografi
kapasitas_kelas(k_033,50,32).

% LAW
kapasitas_kelas(k_034,60,46).
kapasitas_kelas(k_035,60,24).

% logkom
kapasitas_kelas(k_036,63,61).

% matdis 2
kapasitas_kelas(k_037,69,69).
kapasitas_kelas(k_038,69,59).
kapasitas_kelas(k_039,69,63).
kapasitas_kelas(k_040,69,54).
kapasitas_kelas(k_041,69,69).
kapasitas_kelas(k_042,69,60).

% matdis 1
kapasitas_kelas(k_043,70,58).

% mppi
kapasitas_kelas(k_044,68,67).
kapasitas_kelas(k_045,68,65).
kapasitas_kelas(k_046,68,68).
kapasitas_kelas(k_047,68,64).
kapasitas_kelas(k_048,68,67).

% basket
kapasitas_kelas(k_050,25,13).

% voli
kapasitas_kelas(k_051,25,13).

% Futsal
kapasitas_kelas(k_052,25,17).

% Sepakbola
kapasitas_kelas(k_053,25,21).

% Tenis
kapasitas_kelas(k_054,25,25).

% tenis Meja
kapasitas_kelas(k_055,25,25).

% mpkt a
kapasitas_kelas(k_055,70,70).
kapasitas_kelas(k_056,70,70).
kapasitas_kelas(k_057,70,70).
kapasitas_kelas(k_058,70,67).
kapasitas_kelas(k_059,70,70).
kapasitas_kelas(k_060,70,70).

% pembelajaran mesin
kapasitas_kelas(k_061,60,28).

% pemrograman kompetitif
kapasitas_kelas(k_062,40,13).

% pemrograman lanjut
kapasitas_kelas(k_063,75,69).
kapasitas_kelas(k_064,75,75).
kapasitas_kelas(k_065,75,75).

% pemrograman logika
kapasitas_kelas(k_066,50,28).

% pemrograman paralel
kapasitas_kelas(k_067,50,5).

% pok
kapasitas_kelas(k_068,75,75).
kapasitas_kelas(k_069,78,75).
kapasitas_kelas(k_070,75,72).

% psd
kapasitas_kelas(k_071,50,30).

% nlp
kapasitas_kelas(k_072,50,17).

% ppw
kapasitas_kelas(k_073,60,22).

% persamaan Diferensial
kapasitas_kelas(k_074,50,2).

% ppl
kapasitas_kelas(k_075,50,29).
kapasitas_kelas(k_076,50,45).
kapasitas_kelas(k_077,50,45).
kapasitas_kelas(k_078,50,44).

% robotika
kapasitas_kelas(k_079,50,11).

% sains data
kapasitas_kelas(k_080,60,59).
kapasitas_kelas(k_081,60,60).
kapasitas_kelas(k_082,60,23).

% SC
kapasitas_kelas(k_083,50,22).

% sister
kapasitas_kelas(k_084,71,71).
kapasitas_kelas(k_085,69,68).
kapasitas_kelas(k_086,70,64).
kapasitas_kelas(k_087,68,67).
kapasitas_kelas(k_088,71,69).

% sistem operasi
kapasitas_kelas(k_089,60,59).
kapasitas_kelas(k_090,60,53).
kapasitas_kelas(k_091,64,64).

% Sistem operasi untuk Sistem informasi
kapasitas_kelas(k_092,73,70).
kapasitas_kelas(k_093,73,73).
kapasitas_kelas(k_094,73,73).

% statprob
kapasitas_kelas(k_095,66,66).
kapasitas_kelas(k_096,66,66).
kapasitas_kelas(k_097,69,60).
kapasitas_kelas(k_098,67,67).
kapasitas_kelas(k_099,66,64).
kapasitas_kelas(k_100,66,63).

% sda
kapasitas_kelas(k_101,60,60).
kapasitas_kelas(k_102,60,59).

% tba
kapasitas_kelas(k_103,69,69).
kapasitas_kelas(k_104,65,61).
kapasitas_kelas(k_105,68,68).